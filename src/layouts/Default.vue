<template>
  ...
  >
    <header class="border-t-14 border-pink-600">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        ...
        >
          ...
          <li class="mr-8 mb-6 lg:mb-0">
            ...
            >A propos</a>
            <g-link v-else to="/#about" class="text-copy-primary hover:text-gray-600">A propos</g-link>
          </li>
          <li class="mr-8 mb-6 lg:mb-0">
            <a
              v-if="$route.path === '/'"
              ...
              class="text-copy-primary hover:text-gray-600"
            >Les visites</a>
            <g-link v-else to="/#visites" class="text-copy-primary hover:text-gray-600">Visites</g-link>
          </li>
          <li class="mr-8 mb-6 lg:mb-0">
            <a
              v-if="$route.path === '/'"
    ...
    <footer class="bg-pink-600 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0 sm:hidden:flex sm:hidden:flex-col sm:hidden:items-center">
          <div>Tous droits réservés. Copyright {{ new Date().getFullYear() }}.</div>
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a :href="formUrl" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a
              href="https://www.facebook.com/cloeisamarga"
              target="_blank"
